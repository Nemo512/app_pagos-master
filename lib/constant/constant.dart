...
const TextStyle blue16BoldTextStyle = const TextStyle(
  fontSize: 16.0,
  color: blueColor,
  fontWeight: FontWeight.bold,
);
...
const TextStyle white142BoldTextStyle = const TextStyle(
  fontSize: 14.0,
  color: whiteColor,
  fontWeight: FontWeight.bold,
);
...
const TextStyle primaryColor12MediumTextStyle = const TextStyle(
  fontSize: 12.0,
  color: primaryColor,
  fontWeight: FontWeight.w500,
);
